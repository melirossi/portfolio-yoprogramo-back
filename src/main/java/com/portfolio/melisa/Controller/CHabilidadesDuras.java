...
import com.portfolio.melisa.Service.SHabilidadesDuras;
import com.portfolio.melisa.dto.dtoHabilidadesDuras;
...
public class CHabilidadesDuras {
    ...
    public ResponseEntity<?> create (@RequestBody dtoHabilidadesDuras dtohabilidadesduras){
        ...
        HabilidadesDuras habilidadesDuras = new HabilidadesDuras(dtohabilidadesduras.getNombreHD());
