...
import com.portfolio.melisa.Service.SExperiencia;
import com.portfolio.melisa.dto.dtoExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexperiencia){      
        ...
        Experiencia experiencia = new Experiencia(dtoexperiencia.getImageE(), dtoexperiencia.getTituloE(), dtoexperiencia.getFechaE(), dtoexperiencia.getNombreE(), dtoexperiencia.getDescripcionE());
        sExperiencia.save(experiencia);
        
        return new ResponseEntity(new Mensaje("Experiencia agregada"), HttpStatus.OK);
    }
    
    // Editar experienica por ID:
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        ...
        Experiencia experiencia = sExperiencia.getOne(id).get();
        experiencia.setImageE(dtoexp.getImageE());
